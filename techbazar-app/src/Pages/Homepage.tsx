...
export const HomePage = () => {
  return (
    <div className="HomePage">
      ...
      <div style={{ margin: "60px 80px 0px 80px " }}>
        <Heading fontSize="24px" margin={"0px 0px 36px 0px"}>
          Service To Help Ypu Shop
        </Heading>

        <div className="offerCards">
           <div style={{width:"31%", borderRadius:"12px", background:"#e7e7e7", paddingTop:"22px"}}>
            <Heading fontSize={"30px"} margin={"2px 18px 0px 18px"} >Frequently Asked Questions</Heading>
            <Text fontSize={"14px"}  margin={"16px 18px 20px 18px"}>Exploring Our Furniture And home Furnishing Range</Text>
            <div style={{height:"260px"}}>
                <img style={{width:"100%",height:"100%" ,objectFit:"cover", borderRadius:"0px 0px 12px 12px"}} src="https://media.istockphoto.com/id/1153990996/photo/family-fun-for-the-smart-generation.jpg?s=612x612&w=0&k=20&c=OwDdnft4jPuK0L24G4k8h1PFBCFXc9HvOvtDTrfmgC8=" alt="image" />
            </div>
           </div>
           <div style={{width:"31%", borderRadius:"12px", background:"#e7e7e7", paddingTop:"22px"}}>
            <Heading fontSize={"30px"} margin={"2px 18px 0px 18px"} >Frequently Asked Questions</Heading>
            <Text fontSize={"14px"}  margin={"16px 18px 20px 18px"}>Exploring Our Furniture And home Furnishing Range</Text>
            <div style={{height:"260px"}}>
                <img style={{width:"100%",height:"100%" ,objectFit:"cover", borderRadius:"0px 0px 12px 12px"}} src="https://cdn.corporatefinanceinstitute.com/assets/online-payment-companies-1024x683.jpeg" alt="image" />
            </div>
           </div>
           <div style={{width:"31%", borderRadius:"12px", background:"#e7e7e7", paddingTop:"22px"}}>
            <Heading fontSize={"30px"} margin={"2px 18px 0px 18px"} >Frequently Asked Questions</Heading>
            <Text fontSize={"14px"}  margin={"16px 18px 20px 18px"}>Exploring Our Furniture And home Furnishing Range</Text>
            <div style={{height:"260px"}}>
                <img style={{width:"100%",height:"100%" ,objectFit:"cover", borderRadius:"0px 0px 12px 12px"}} src="https://media.istockphoto.com/id/1221101939/photo/delivery-concept-asian-man-hand-accepting-a-delivery-boxes-from-professional-deliveryman-at.jpg?s=612x612&w=0&k=20&c=jvZ_phbXmzOrCCZiGn8ZQO99a5skBJlclbujI5jGam8=" alt="image" />
            </div>
           </div>
